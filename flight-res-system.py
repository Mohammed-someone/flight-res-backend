...
def test_all_classes_and_relationships():
    ...
    try:
        ...
        # Tickets
        ticket1 = Ticket(ticket_number="T001", passenger_id=passenger1.id, flight_number="DL123", seat_number="1A", ticket_class="economy")
        ticket2 = Ticket(ticket_number="T002", passenger_id=passenger2.id, flight_number="AA456", seat_number="2B", ticket_class="business")
